...
const PublishForm=()=>{
    ...
    let {blog:{banner,content,title,tags,des},setEditorState,setBlog,blog}=useContext(EditorContext);
    ...
    const publishBlog =(e)=>{
        ...
        if(!des.length || des.length>characterLimit){
            return toast.error(`Write blog description within ${characterLimit} before publishing`)
        }
         ...
         <section className='w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4'>
            ...
            <div className='max-w-[550px] center'>
                ...
                <div className='border-grey lg:border-1 lg:pl-8'>
                    ...
                    <p className='text-dark-grey mb-2 mt-9'>Topics- (Helps in serching and ranking your blog post) </p>
