...
const CommentCard =({index,leftVal,commentData})=>{
   ...
   let{blog,blog:{comments,activity,activity:{total_parent_comments},comments:{results:commentsArr},author:{personal_info:{username:blog_autor}}},setBlog,setParentCommentsLoaded}=useContext(BlogContext)
   ...
   const getParentIndex=()=>{
    ...
    try{
        while(commentsArr[startinPoint].childrenLevel>=commentData.childrenLevel){
            startingPoint--;
        }
    }catch{
   ...
   const removeCommentsCards = (startingPoint,isDelete=false)=>{
    ...
    if(isDelete){
        ...
        if(parentIndex!=undefined){
            commentsArr[parentIndex].children=commentArr[parentIndex].children.filter(child=>child!=_id)
    ...
    if(commentData.childrenLevel==0&&isDelete){
        setParentCommentsLoaded(preVal=>preVal-1)
    }
    setBlog({...blog,comments :{results:commentsArr},activity:{...activity,total_parent_comments:tottal_parent_comments-(commentData.childrenLevel==0 && isDelete ? 1:0)}})
   }
